        ...
        <div className="container">
            ...
            <div className="navbar-header">
              ...
              <a href="http://www.1way.io">
                <div className="logo-container">
                  ...
                  >
                    <img
                      src="assets/img/ow_icon_cloud.png"
                      alt="One Way Logo"
                    />
                  </div>
                  <div className="brand" />
          ...
          <div className="collapse navbar-collapse" id="navbarMain">
            <ul className="navbar-nav mr-auto">
              ...
              <li>
                <Link to="/register-place" className="nav-link">
                  {' '}
                  Register Place
                </Link>
              </li>
              ...
              <li className="nav-item">
                <Link to="/GitMapData" className="nav-link">
                  {' '}
                  GitMapData
                </Link>
              </li>
              <li className="nav-item">
                <Link to="/HotSpotsPage" className="nav-link">
                  {' '}
                  Places
                </Link>
              </li>
              ...
              <li className="nav-item">
                <Link to="/UserAddressBook" className="nav-link">
                  {' '}
                  UserAddressBook
                </Link>
              </li>
