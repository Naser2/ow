...
export default class SmallMapCard extends Component {
  render() {
    return (
      <div class="ui cards" style={{float:"left",  paddingLeft: "1.58571429em"}}><div class="ui card"><div class="content" style={{textAlign: "center", marginLeft:"10px"}}><img src={""} alt="googl"
