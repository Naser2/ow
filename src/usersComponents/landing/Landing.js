...
<body class="landing-page landing-page1" style={{
                ...
                <div class="wrapper">
                    <div class="parallax filter-gradient blue" data-color="blue">
                        <div class="parallax-background">
                            <img class="parallax-background-image" src="assets/img/template/Home_2x-3rd.jpg" alt="#"/>
                        </div>
                        <div class= "container">
                            <div class="row">
                                <div class="col-md-5 hidden-xs">
                                    <div class="parallax-image">
                                        <img class="phone" src="assets/img/template/iphone3.png" style={{"margin-top": "20px"}}  alt="#"/>
                                    </div>
                                </div>
                    ...
                    <div class="section section-presentation" style={{
                        'padding': '0',
                        // position: relative;
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-5 col-md-offset-1 hidden-xs" style={{
                    ...
                    <div class="section section-demo"
                            ...
                            <div class="row">
                                ...
                                >
                                    <h4 class="header-text" style={{ //Header
                                        'margin-top': "20px",
                                    ...
                                    >
                                    OneWay is an app that allows you create numeric addresses for your residences, <br></br>office, or places of commerce.Once created, an address it is geo-localizable for delivery purpose and you can share it to visiting friends.
                                    OneWay makes traveling easy with integrated geolocation support. <br></br><br></br> -  "To Each One An Address". 
                                    </p>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="card card-blue">
                                        ...
                                        <img class="phone" src="assets/img/template/one-way-hands-friends.png" 
                                        style={{
                                            // "margin-top": "20px"
                                            // *  border-radius: 15px
                                            "height": "220px",
    ...
    // cursor: pointer;
                    ...
                    <div class="section section-no-padding">
                        <div class="parallax filter-gradient blue" data-color="blue">
                            <div class="parallax-background">
                                <img class ="parallax-background-image" src="assets/img/template/street-ow-bg.jpg"alt="#"/>
                            </div>
                            <div class="info">
